...
def db_admin_serialize_node(session, tid, language):
    ...
    misc_dict = {
        ...
        'languages_enabled': EnabledLanguage.list(session, tid),
...
def db_update_enabled_languages(session, tid, languages_enabled, default_language):
    cur_enabled_langs = EnabledLanguage.list(session, tid)
    ...
    for lang_code in new_enabled_langs:
        ...
        if lang_code not in cur_enabled_langs:
            ...
            EnabledLanguage.add_new_lang(session, tid, lang_code, appdata)
    ...
    if to_remove:
        ...
        models.db_delete(session, models.l10n.EnabledLanguage, models.l10n.EnabledLanguage.name.in_(to_remove), models.l10n.EnabledLanguage.tid == tid)
